...
// Affiche ou efface le menu déroulant de choix du tri
    if (menu.classList.contains("deploy")) { 
        ...
        menu.innerHTML = `
            <button class="sorting_menu btn" role="button" aria-haspopup="listbox" aria-expanded="false">
        ...
        menu.innerHTML = `
            <div class="sorting_list" role="listbox" aria-activedescendant="">
                <button class="sorting-element" value="Popularité">Popularité <i class="fa fa-angle-up"></i></button>
                <hr>
                <button class="sorting-element" value="Date">Date</button>
                <hr>
                <button class="sorting-element" value="Titre">Titre</button>
            </div>
        `;
